    ...
    onderwerpen: [
      {
        ...
        intro: "Voor een serviceklus. Een verkort rapport naar de opdrachtgever, zonder handtekening of voorvertoning.",
        punten: [
          "Schrijf of spreek een kort begeleidend bericht in (mag leeg).",
          "Is het werk nog niet klaar? Zet onderaan 'Klus is niet af' aan.",
        ],
      ...
      },
      {
        ...
        intro: "De volledige oplevering, voor een keuken. Foto, video en handtekening zijn altijd optioneel.",
        punten: [
          "Voeg foto's en eventueel een video van de oplevering toe.",
          "Onderaan laat je de klant tekenen en verstuur je het rapport.",
        ],
      ...
      },
      {
        ...
        intro: "Zo ziet een opgeleverde klus eruit.",
        punten: [
          "Bovenaan staat 'Opgeleverd' met de datum, de balk is groen.",
          "Komt er nog een vervolg, dan kan kantoor de klus heropenen.",
        ],
        route: "/opdracht/:id",
      },
      {
  ...
  },
  {
    ...
    onderwerpen: [
      ...
      },
      {
        ...
        intro: "Optioneel: lever de klus ook aan de klant op.",
        punten: [
          "Zet 'Ook aan de klant opleveren' aan; dan verschijnt 'Naar de klant' bij Versturen.",
          "De interne notitie gaat niet mee naar de klant.",
        ],
        route: "/opdracht/:id/opleveren",
