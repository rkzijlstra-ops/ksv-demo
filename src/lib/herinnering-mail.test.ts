...
describe("herinneringTekst", () => {
  it("noemt bij één klus de klant in onderwerp en tekst", () => {
    ...
    expect(subject).toBe("Herinnering: bevestig je klus voor Fam. Bakker");
  ...
  it("somt bij meerdere klussen het aantal en de namen op", () => {
    ...
    expect(subject).toBe("Herinnering: bevestig je 3 klussen");
    expect(text).toContain("3 klussen nog niet bevestigd");
