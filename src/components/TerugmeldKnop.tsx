 ...
 * uit zijn actieve pool (komt in zijn history) en kantoor krijgt bericht. Zit in de klikbare kaart, dus
 * de klik wordt onderschept (geen navigatie naar detail).
 */
        ...
        >
          <div className="w-full max-w-md border-2 border-ink bg-white p-5" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="mt-1 text-sm text-ink-muted">
              Klus voor <span className="font-bold">{klantNaam}</span>. Hij verdwijnt uit je werkpool en
              kantoor krijgt bericht. Je vindt hem terug in je geschiedenis.
            </p>
