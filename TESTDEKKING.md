...
| Al opgeleverd rapport opnieuw openen (trigger = status opgeleverd): eigen klus = waarschuwing-dialoog, opdrachtgever-klus = read-only weergave + afsluit-hub "Rapport bekijken"; heropende klus weer bewerkbaar | U, E | oplever-toegang.test (opgeleverd-trigger), oplever-readonly.spec | groen |
