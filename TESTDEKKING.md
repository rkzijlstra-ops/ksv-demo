...
| Al verstuurd rapport opnieuw openen: eigen klus = waarschuwing-dialoog (Annuleren/Ga door), opdrachtgever-klus = read-only weergave (geen invoer/verstuurknoppen), afsluit-hub toont "Rapport bekijken"; omlijnde video-knop in rapport | U, E | oplever-toegang.test, oplever-readonly.spec; rapport-knop visueel door Rein | groen |
